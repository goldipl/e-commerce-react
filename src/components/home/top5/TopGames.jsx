...
export const TopGames = () => {
  const randomFiveGames = useMemo(
    () => [...PS5GAMES].sort(() => Math.random() - 0.5).slice(0, 5),
    [],
  );
      ...
      <SeoTextContainer>
        ...
        <ol>
          ...
          <li>
            ...
            game we offer meets the highest quality standards, so every purchase
            brings unforgettable experiences and satisfaction.
          </li>
        </ol>
        <p>
